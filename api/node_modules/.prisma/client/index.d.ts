...
export class PrismaClient<
  ...
  */
   ...
   * `prisma.commentLike`: Exposes CRUD operations for the **CommentLike** model.
    ...
    * ```
    */
  get commentLike(): Prisma.CommentLikeDelegate<GlobalReject>;
...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    Like?: boolean | CommentLikeFindManyArgs
    Post?: boolean | PostFindManyArgs
    PostLike?: boolean | PostLikeFindManyArgs
  }
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        P extends 'Like'
        ? Array < CommentLikeGetPayload<S['include'][P]>>  :
        P extends 'Post'
        ? Array < PostGetPayload<S['include'][P]>>  :
        P extends 'PostLike'
        ? Array < PostLikeGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        P extends 'Like'
        ? Array < CommentLikeGetPayload<S['select'][P]>>  :
        P extends 'Post'
        ? Array < PostGetPayload<S['select'][P]>>  :
        P extends 'PostLike'
        ? Array < PostLikeGetPayload<S['select'][P]>>  : never
  } 
    : User
  : User
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    Like<T extends CommentLikeFindManyArgs = {}>(args?: Subset<T, CommentLikeFindManyArgs>): CheckSelect<T, PrismaPromise<Array<CommentLike>>, PrismaPromise<Array<CommentLikeGetPayload<T>>>>;
    ...
    PostLike<T extends PostLikeFindManyArgs = {}>(args?: Subset<T, PostLikeFindManyArgs>): CheckSelect<T, PrismaPromise<Array<PostLike>>, PrismaPromise<Array<PostLikeGetPayload<T>>>>;
  ...
  export type CommentSelect = {
    ...
    userId?: boolean
    Like?: boolean | CommentLikeFindManyArgs
    commentReply?: boolean | CommentArgs
    Comment?: boolean | CommentFindManyArgs
    commentId?: boolean
  }
  ...
  export class Prisma__CommentClient<T> implements PrismaPromise<T> {
    ...
    commentReply<T extends CommentArgs = {}>(args?: Subset<T, CommentArgs>): CheckSelect<T, Prisma__CommentClient<Comment | null >, Prisma__CommentClient<CommentGetPayload<T> | null >>;
  ...
  export type AggregateCommentLike = {
    count: CommentLikeCountAggregateOutputType | null
    avg: CommentLikeAvgAggregateOutputType | null
    sum: CommentLikeSumAggregateOutputType | null
    min: CommentLikeMinAggregateOutputType | null
    max: CommentLikeMaxAggregateOutputType | null
  }
  ...
  export type CommentLikeAggregateArgs = {
    ...
    **/
    orderBy?: Enumerable<CommentLikeOrderByInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
    ...
    **/
    count?: true | CommentLikeCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
    avg?: CommentLikeAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    sum?: CommentLikeSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    min?: CommentLikeMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    max?: CommentLikeMaxAggregateInputType
  }

  export type GetCommentLikeAggregateType<T extends CommentLikeAggregateArgs> = {
    [P in keyof T & keyof AggregateCommentLike]: P extends 'count'
      ? T[P] extends true
        ? number
  ...
  export type CommentLikeGetPayload<
    S extends boolean | null | undefined | CommentLikeArgs,
    U = keyof S
      > = S extends true
        ? CommentLike
    : S extends undefined
    ? never
    : S extends CommentLikeArgs | CommentLikeFindManyArgs
    ?'include' extends U
    ? CommentLike  & {
    [P in TrueKeys<S['include']>]: 
          P extends 'comment'
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof CommentLike ?CommentLike [P]
  : 
          P extends 'comment'
        ? CommentGetPayload<S['select'][P]> | null :
        P extends 'user'
  ...
  export interface CommentLikeDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends CommentLikeFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, CommentLikeFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'CommentLike'> extends True ? CheckSelect<T, Prisma__CommentLikeClient<CommentLike>, Prisma__CommentLikeClient<CommentLikeGetPayload<T>>> : CheckSelect<T, Prisma__CommentLikeClient<CommentLike | null >, Prisma__CommentLikeClient<CommentLikeGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends CommentLikeFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, CommentLikeFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'CommentLike'> extends True ? CheckSelect<T, Prisma__CommentLikeClient<CommentLike>, Prisma__CommentLikeClient<CommentLikeGetPayload<T>>> : CheckSelect<T, Prisma__CommentLikeClient<CommentLike | null >, Prisma__CommentLikeClient<CommentLikeGetPayload<T> | null >>
    ...
    **/
    findMany<T extends CommentLikeFindManyArgs>(
      args?: SelectSubset<T, CommentLikeFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<CommentLike>>, PrismaPromise<Array<CommentLikeGetPayload<T>>>>
    ...
    **/
    create<T extends CommentLikeCreateArgs>(
      args: SelectSubset<T, CommentLikeCreateArgs>
    ): CheckSelect<T, Prisma__CommentLikeClient<CommentLike>, Prisma__CommentLikeClient<CommentLikeGetPayload<T>>>
    ...
    **/
    delete<T extends CommentLikeDeleteArgs>(
      args: SelectSubset<T, CommentLikeDeleteArgs>
    ): CheckSelect<T, Prisma__CommentLikeClient<CommentLike>, Prisma__CommentLikeClient<CommentLikeGetPayload<T>>>
    ...
    **/
    update<T extends CommentLikeUpdateArgs>(
      args: SelectSubset<T, CommentLikeUpdateArgs>
    ): CheckSelect<T, Prisma__CommentLikeClient<CommentLike>, Prisma__CommentLikeClient<CommentLikeGetPayload<T>>>
    ...
    **/
    deleteMany<T extends CommentLikeDeleteManyArgs>(
      args?: SelectSubset<T, CommentLikeDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    updateMany<T extends CommentLikeUpdateManyArgs>(
      args: SelectSubset<T, CommentLikeUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    upsert<T extends CommentLikeUpsertArgs>(
      args: SelectSubset<T, CommentLikeUpsertArgs>
    ): CheckSelect<T, Prisma__CommentLikeClient<CommentLike>, Prisma__CommentLikeClient<CommentLikeGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends CommentLikeAggregateArgs>(args: Subset<T, CommentLikeAggregateArgs>): PrismaPromise<GetCommentLikeAggregateType<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CommentLikeClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type CommentLikeFindUniqueArgs = {
    ...
    **/
    select?: CommentLikeSelect | null
    /**
     * Choose, which related nodes to fetch as well.
    **/
    include?: CommentLikeInclude | null
    /**
     * Throw an Error if a CommentLike can't be found
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
  ...
  export type AggregatePostLike = {
    count: PostLikeCountAggregateOutputType | null
    avg: PostLikeAvgAggregateOutputType | null
    sum: PostLikeSumAggregateOutputType | null
    min: PostLikeMinAggregateOutputType | null
    max: PostLikeMaxAggregateOutputType | null
  }
  ...
  export type PostLikeAggregateArgs = {
    ...
    **/
    orderBy?: Enumerable<PostLikeOrderByInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
    ...
    **/
    count?: true | PostLikeCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
    avg?: PostLikeAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    sum?: PostLikeSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    min?: PostLikeMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    max?: PostLikeMaxAggregateInputType
  }

  export type GetPostLikeAggregateType<T extends PostLikeAggregateArgs> = {
    [P in keyof T & keyof AggregatePostLike]: P extends 'count'
      ? T[P] extends true
        ? number
  ...
  export type PostLikeGetPayload<
    S extends boolean | null | undefined | PostLikeArgs,
    U = keyof S
      > = S extends true
        ? PostLike
    : S extends undefined
    ? never
    : S extends PostLikeArgs | PostLikeFindManyArgs
    ?'include' extends U
    ? PostLike  & {
    [P in TrueKeys<S['include']>]: 
          P extends 'post'
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof PostLike ?PostLike [P]
  : 
          P extends 'post'
        ? PostGetPayload<S['select'][P]> :
        P extends 'user'
  ...
  export interface PostLikeDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'PostLike'> extends True ? CheckSelect<T, Prisma__PostLikeClient<PostLike>, Prisma__PostLikeClient<PostLikeGetPayload<T>>> : CheckSelect<T, Prisma__PostLikeClient<PostLike | null >, Prisma__PostLikeClient<PostLikeGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'PostLike'> extends True ? CheckSelect<T, Prisma__PostLikeClient<PostLike>, Prisma__PostLikeClient<PostLikeGetPayload<T>>> : CheckSelect<T, Prisma__PostLikeClient<PostLike | null >, Prisma__PostLikeClient<PostLikeGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<PostLike>>, PrismaPromise<Array<PostLikeGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__PostLikeClient<PostLike>, Prisma__PostLikeClient<PostLikeGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__PostLikeClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type PostLikeFindUniqueArgs = {
    ...
    **/
    ...
    /**
     * Throw an Error if a PostLike can't be found
    **/
    rejectOnNotFound?: RejectOnNotFound
    /**
  ...
  export type CommentWhereInput = {
    ...
    Like?: CommentLikeListRelationFilter
    commentReply?: XOR<CommentRelationFilter, CommentWhereInput> | null
    Comment?: CommentListRelationFilter
  ...
  export type CommentOrderByInput = {
    ...
    userId?: SortOrder
    commentReply?: CommentOrderByInput
    commentId?: SortOrder
  }
  ...
  export type UserCreateInput = {
    ...
    Like?: CommentLikeCreateNestedManyWithoutUserInput
  ...
  export type UserUncheckedCreateInput = {
    ...
    Like?: CommentLikeUncheckedCreateNestedManyWithoutUserInput
  ...
  export type UserUpdateInput = {
    ...
    Like?: CommentLikeUpdateManyWithoutUserInput
    Post?: PostUpdateManyWithoutUserInput
    PostLike?: PostLikeUpdateManyWithoutUserInput
  }
  ...
  export type UserUncheckedUpdateInput = {
    ...
    Like?: CommentLikeUncheckedUpdateManyWithoutUserInput
    Post?: PostUncheckedUpdateManyWithoutUserInput
    PostLike?: PostLikeUncheckedUpdateManyWithoutUserInput
  }
  ...
  export type CommentCreateInput = {
    ...
    commentReply?: CommentCreateNestedOneWithoutCommentInput
    Comment?: CommentCreateNestedManyWithoutCommentReplyInput
  }
  ...
  export type CommentUncheckedCreateInput = {
    ...
    Comment?: CommentUncheckedCreateNestedManyWithoutCommentReplyInput
  }
  ...
  export type CommentUpdateInput = {
    ...
    Like?: CommentLikeUpdateManyWithoutCommentInput
    commentReply?: CommentUpdateOneWithoutCommentInput
    Comment?: CommentUpdateManyWithoutCommentReplyInput
  }
  ...
  export type CommentUncheckedUpdateInput = {
    ...
    Like?: CommentLikeUncheckedUpdateManyWithoutCommentInput
    Comment?: CommentUncheckedUpdateManyWithoutCommentReplyInput
  }
  ...
  export type PostLikeUpdateInput = {
    post?: PostUpdateOneRequiredWithoutPostLikeInput
    user?: UserUpdateOneRequiredWithoutPostLikeInput
  }
  ...
  export type PostUpdateInput = {
    ...
    PostLike?: PostLikeUpdateManyWithoutPostInput
  }
  ...
  export type PostUncheckedUpdateInput = {
    ...
    PostLike?: PostLikeUncheckedUpdateManyWithoutPostInput
  }
  ...
  export type PostLikeUpdateManyWithoutUserInput = {
    create?: XOR<Enumerable<PostLikeCreateWithoutUserInput>, Enumerable<PostLikeUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<PostLikeCreateOrConnectWithoutUserInput>
  ...
  export type CommentCreateNestedManyWithoutCommentReplyInput = {
    create?: XOR<Enumerable<CommentCreateWithoutCommentReplyInput>, Enumerable<CommentUncheckedCreateWithoutCommentReplyInput>>
    connectOrCreate?: Enumerable<CommentCreateOrConnectWithoutCommentReplyInput>
    connect?: Enumerable<CommentWhereUniqueInput>
  }
  ...
  export type CommentUncheckedCreateNestedManyWithoutCommentReplyInput = {
    create?: XOR<Enumerable<CommentCreateWithoutCommentReplyInput>, Enumerable<CommentUncheckedCreateWithoutCommentReplyInput>>
    connectOrCreate?: Enumerable<CommentCreateOrConnectWithoutCommentReplyInput>
    connect?: Enumerable<CommentWhereUniqueInput>
  }
  ...
  export type CommentUpdateManyWithoutCommentReplyInput = {
    create?: XOR<Enumerable<CommentCreateWithoutCommentReplyInput>, Enumerable<CommentUncheckedCreateWithoutCommentReplyInput>>
    connectOrCreate?: Enumerable<CommentCreateOrConnectWithoutCommentReplyInput>
    upsert?: Enumerable<CommentUpsertWithWhereUniqueWithoutCommentReplyInput>
    connect?: Enumerable<CommentWhereUniqueInput>
    set?: Enumerable<CommentWhereUniqueInput>
    disconnect?: Enumerable<CommentWhereUniqueInput>
    delete?: Enumerable<CommentWhereUniqueInput>
    update?: Enumerable<CommentUpdateWithWhereUniqueWithoutCommentReplyInput>
    updateMany?: Enumerable<CommentUpdateManyWithWhereWithoutCommentReplyInput>
    deleteMany?: Enumerable<CommentScalarWhereInput>
  }
  ...
  export type CommentUncheckedUpdateManyWithoutCommentReplyInput = {
    create?: XOR<Enumerable<CommentCreateWithoutCommentReplyInput>, Enumerable<CommentUncheckedCreateWithoutCommentReplyInput>>
    connectOrCreate?: Enumerable<CommentCreateOrConnectWithoutCommentReplyInput>
    upsert?: Enumerable<CommentUpsertWithWhereUniqueWithoutCommentReplyInput>
    connect?: Enumerable<CommentWhereUniqueInput>
  ...
  export type CommentUpdateOneWithoutLikeInput = {
    create?: XOR<CommentCreateWithoutLikeInput, CommentUncheckedCreateWithoutLikeInput>
    connectOrCreate?: CommentCreateOrConnectWithoutLikeInput
  ...
  export type PostUpdateOneRequiredWithoutPostLikeInput = {
    create?: XOR<PostCreateWithoutPostLikeInput, PostUncheckedCreateWithoutPostLikeInput>
    connectOrCreate?: PostCreateOrConnectWithoutPostLikeInput
  ...
  export type UserUpdateOneRequiredWithoutPostLikeInput = {
    create?: XOR<UserCreateWithoutPostLikeInput, UserUncheckedCreateWithoutPostLikeInput>
    connectOrCreate?: UserCreateOrConnectWithoutPostLikeInput
  ...
  export type PostLikeUpdateManyWithoutPostInput = {
    create?: XOR<Enumerable<PostLikeCreateWithoutPostInput>, Enumerable<PostLikeUncheckedCreateWithoutPostInput>>
    connectOrCreate?: Enumerable<PostLikeCreateOrConnectWithoutPostInput>
  ...
  export type CommentLikeUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<CommentLikeUpdateManyMutationInput, CommentLikeUncheckedUpdateManyWithoutLikeInput>
  }
  ...
  export type CommentCreateWithoutCommentReplyInput = {
    comment: string
    post: PostCreateNestedOneWithoutCommentInput
    user: UserCreateNestedOneWithoutCommentInput
    Like?: CommentLikeCreateNestedManyWithoutCommentInput
  ...
  export type CommentUncheckedCreateWithoutCommentReplyInput = {
    id?: number
    comment: string
    postId: number
    userId: number
  ...
  export type CommentCreateOrConnectWithoutCommentReplyInput = {
    where: CommentWhereUniqueInput
    create: XOR<CommentCreateWithoutCommentReplyInput, CommentUncheckedCreateWithoutCommentReplyInput>
  }
  ...
  export type CommentUpsertWithWhereUniqueWithoutCommentReplyInput = {
    where: CommentWhereUniqueInput
    update: XOR<CommentUpdateWithoutCommentReplyInput, CommentUncheckedUpdateWithoutCommentReplyInput>
    create: XOR<CommentCreateWithoutCommentReplyInput, CommentUncheckedCreateWithoutCommentReplyInput>
  }

  export type CommentUpdateWithWhereUniqueWithoutCommentReplyInput = {
    where: CommentWhereUniqueInput
    data: XOR<CommentUpdateWithoutCommentReplyInput, CommentUncheckedUpdateWithoutCommentReplyInput>
  }

  export type CommentUpdateManyWithWhereWithoutCommentReplyInput = {
    where: CommentScalarWhereInput
    data: XOR<CommentUpdateManyMutationInput, CommentUncheckedUpdateManyWithoutCommentInput>
  }
  ...
  export type CommentLikeUncheckedUpdateManyWithoutLikeInput = {
    id?: IntFieldUpdateOperationsInput | number
    commentId?: NullableIntFieldUpdateOperationsInput | number | null
  }
  ...
  export type CommentUpdateWithoutCommentReplyInput = {
    comment?: StringFieldUpdateOperationsInput | string
    post?: PostUpdateOneRequiredWithoutCommentInput
    user?: UserUpdateOneRequiredWithoutCommentInput
    Like?: CommentLikeUpdateManyWithoutCommentInput
  ...
  export type CommentUncheckedUpdateWithoutCommentReplyInput = {
    id?: IntFieldUpdateOperationsInput | number
    comment?: StringFieldUpdateOperationsInput | string
    postId?: IntFieldUpdateOperationsInput | number
    userId?: IntFieldUpdateOperationsInput | number
